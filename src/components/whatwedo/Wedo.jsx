 ...
 <div className="wedoo" id='Wedo'>
    ...
    <div className="wrapper">
      ...
      <div className='three-box'>
         ...
         <div className="onee">
          <div className="tala">
           <img src="../../../public/img/service/1.svg"  alt="tala" />
              </div>
        ...
        <div className="twopri">
               <img src="../../../public/img/service/2.svg" alt="service" />
        </div>
       ...
       <div className="thereimg"><img src="../../../public/img/service/3.svg" alt="" /></div> 
      ...
      <div className="wedoservice">
           < div id="groupone">{/*group--one-start */}
               ...
               <div className="serviceone">
                 <div className="oneimg"><img     className='weimg'  src="../../../public/what we do/New folder/1.png" alt="" /></div>
            ...
            < div className="servicethree">
             ...
             <div id="grouptwo">{/*group--two- */}
              <div className="servicefour">
                  <div className="fourimg"><img className='weimg' src="../../../public/what we do/New folder/4.png" alt="" />
                 </div>
               ...
               <div className="servicefive">
                   <div className="fiveimg">
                    <img className='weimg' src="../../../public/what we do/New folder/5.png" alt="" />
                    </div> 
                  ...
                  <div className="servicesix">
                      <div className="siximg"><img  className='weimg' src="../../../public/what we do/New folder/6.png" alt="" /></div> 
           ...
           <div id="grouptwo-hide">
             <div className="servicethree">
              ...
              <div id="groupthree-hide"> 
                 <div className="servicefive">
                   <div className="fiveimg">
                    <img className='weimg'  src="../../../public/what we do/New folder/5.png" alt="" /> </div> 
                   <h3  className='peni'>Security Consult </h3>
                   <div className='pen'>Security consulting is a service  provided by security professionals  to help organizations identify.</div>
               </div>
                <div className="servicesix">
